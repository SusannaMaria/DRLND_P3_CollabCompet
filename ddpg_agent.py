...
class AgentDDPG():
    ...
    def learn(self, experiences, gamma):
        ...
        self.soft_update(self.critic_local, self.critic_target, float(self.cfg['TAU']))
        self.soft_update(self.actor_local, self.actor_target, float(self.cfg['TAU']))
...
class OUNoise:
    ...
    def __init__(self, size, seed, mu=0., theta=0., sigma=0.):
